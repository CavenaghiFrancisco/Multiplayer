...
namespace ParrelSync.Example
{
    public class CustomArgumentExample : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                UnityEngine.Debug.Log("This is a clone project.");

                //Argument can be set from the clones manager window.               
                string customArgument = ClonesManager.GetArgument();
                UnityEngine.Debug.Log("The custom argument of this clone project is: " + customArgument);
                // Do what ever you need with the argument string.
            }
            else
            {
                UnityEngine.Debug.Log("This is the original project.");
            }
        }
    }
}
